        ...
        <div className="flex items-center justify-between h-20 min-w-0">
          ...
          <Link to="/" className="flex items-center space-x-2 sm:space-x-3 flex-shrink-0 min-w-0">
            <img
              ...
              alt="イラストーク大学 Logo"
              className="w-10 h-10 rounded-lg object-cover shadow-soft flex-shrink-0"
            />
            <span className="text-lg sm:text-xl font-bold text-white hidden sm:block whitespace-nowrap">イラストーク大学</span>
          </Link>

          {/* 検索バー */}
          <div className="flex-1 max-w-md lg:max-w-lg mx-3 lg:mx-6 hidden md:block min-w-0">
            <form onSubmit={handleSearch} className="relative">
              <input
                ...
                className="w-full pl-10 lg:pl-12 pr-4 lg:pr-5 py-2.5 lg:py-3 bg-white border-0 rounded-lg focus:outline-none focus:ring-2 focus:ring-accent-400 shadow-soft text-text-primary placeholder:text-text-tertiary text-sm lg:text-base"
              />
              <Search className="absolute left-3 lg:left-4 top-1/2 transform -translate-y-1/2 h-4 w-4 lg:h-5 lg:w-5 text-text-tertiary" />
            </form>
          </div>
          ...
          <nav className="hidden xl:flex items-center space-x-2 2xl:space-x-3">
            <Link
              to="/manga"
              className={`px-2 2xl:px-3 py-2.5 rounded-lg text-sm font-medium transition-all whitespace-nowrap ${
                isActive('/manga')
            ...
            <span
              className="px-2 2xl:px-3 py-2.5 rounded-lg text-sm font-medium text-white/50 cursor-not-allowed whitespace-nowrap"
              title="近日公開予定"
            >
              コンテスト
            </span>
